    ...
    render(){
        ...
        if(!this.state.detailsAdded){
            ...
            return(
                ...
                <div className="row">
                <p className="profile-headers">Quiz name</p>
                ...
                <div className="row">
                <p className="profile-headers"> Quiz instructions</p>
                ...
                <button className="btn btn-primary" type="Submit">Save &amp; Add Questions</button>
                </form>
            )
        } else {
            return(
                ...
                <button className="profile-button" type="button" name="b1" onClick={this.nextQuestion}>Next Question</button>
                <button className="profile-button" type="submit" name="b2">Save</button>
                </form>
            )
        }
    }
